...
class TripRepository {
  ...
  Future<void> saveCandidates(String tripId, List<CandidateIssue> candidates) async {
    if (_userId == null) return;
  ...
  Future<void> updateTripConfirmedObstacles(String tripId, List<String> obstacleIds) async {
    if (_userId == null) return;
